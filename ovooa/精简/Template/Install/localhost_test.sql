...
CREATE TABLE `advertising` (`id` INT NOT NULL AUTO_INCREMENT , `name` TEXT NOT NULL , `description` TEXT NOT NULL , `url` TEXT NOT NULL , `logo` text not null , `access` text not null , `time` VARCHAR(30) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB charset=utf8mb4;
...
CREATE TABLE `mxgapi_access_api` (
 `id` int(11) NOT NULL AUTO_INCREMENT,
 `access` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '次数',
 `time` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '时间',
 PRIMARY KEY (`id`)
