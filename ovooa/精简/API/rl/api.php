...
$a = "公元".date('Y')."年".date('m')."月".date('d')."日\n";
$b = "\n农历".$today[3]."年".$today[1]."".$today[2]."\n".$today[6]."年\n\n";
...
echo "公元".date('Y')."年".date('m')."月".date('d')."日";

}else

if ($type == "B"){

echo "农历".$today[3]."年".$today[1]."".$today[2]."\n".$today[6]."年$return";
...
echo need::json(array("code"=>1,"data"=>array("AD"=>date('Y')."年".date('m')."月".date('d')."日","lunar"=>$today[3]."年".$today[1].$today[2],"zodiac"=>$today[6]."年","knob"=>$month['name2'])));
