...
$allowtime = 30;//防刷新时间 在提示“警告：不要刷新的太频繁”之后 5秒后重置计算时间
$allownum = 2;//防刷新次数
$allowRefresh = 1;//在允许刷新次数之后加入禁止ip文件中 在提示“警告：不要刷新的太频繁”之后 5秒后可刷新的次数，超过则加入黑名单
...
if (in_array($ip . "\r\n", $filehtarr)) {
    exit(json(array("code"=>"5","text"=>"抱歉，您的ip已被屏蔽。\\n如正常使用情况下被屏蔽，请进群：820323177")));
}
//加入禁止ip
$time = time();
